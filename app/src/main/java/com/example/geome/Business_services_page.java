...
public class Business_services_page extends AppCompatActivity {
    public TextView name_page;
    ...
    ImageButton ImageButtonServices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_services_page);
        ...
        name_page = findViewById(R.id.name_page);
        name_page.setText(selectedCompany.getCompanyName());
        ...
        ImageButtonServices = findViewById(R.id.ImageButtonServices);
        ...
        image_hostel = findViewById(R.id.image);
    ...
    private void initView() {
        ...
        ImageButtonMain_word.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Drawable drawable = ContextCompat.getDrawable(Business_services_page.this,
                        getResources().getIdentifier("main_word", "drawable", getPackageName()));
                drawable.setBounds(0, 0, newWidth, newHeight);
                ImageButtonMain_word.setImageDrawable(drawable);

                Drawable drawable2 = ContextCompat.getDrawable(Business_services_page.this,
                        getResources().getIdentifier("not_services", "drawable", getPackageName()));
                drawable2.setBounds(0, 0, newWidth, newHeight);
                ImageButtonServices.setImageDrawable(drawable2);

                drawable = ContextCompat.getDrawable(Business_services_page.this,
        ...
        ImageButtonServices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Drawable drawable = ContextCompat.getDrawable(Business_services_page.this,
                ...
                Drawable drawable2 = ContextCompat.getDrawable(Business_services_page.this,
                        getResources().getIdentifier("services", "drawable", getPackageName()));
                drawable2.setBounds(0, 0, newWidth, newHeight);
                ImageButtonServices.setImageDrawable(drawable2);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Business_services_page.this, Services.class);
        ...
        ImageButtonProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Business_services_page.this, MainBottomMenuActivity.class);
        ...
        ImageButtonMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Business_services_page.this, HomePage.class);
                startActivity(intent);
            }
        });
